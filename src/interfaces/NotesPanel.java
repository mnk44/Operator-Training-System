...
public class NotesPanel extends JPanel {
	...
	public NotesPanel(ArrayList<Process> processList, ArrayList<User> users) throws SQLException {
		setBorder(null);
		...
		lblGestinDeProcesos = new JLabel("Notas de los operarios:");
		...
		reload(processList, users);
	}
	
	public static void reload(ArrayList<Process> processList, ArrayList<User> users) throws SQLException{
		DataTable.fillNotes(date, table, processList, users);
